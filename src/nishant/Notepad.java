...
public class Notepad extends JFrame implements ActionListener {
    ...
    private final MenuBar menuBar = new MenuBar(); // first, create a MenuBar item
    private final Menu file = new Menu(); // our File menu
    // what's going in File? let's see...
    private final MenuItem openFile = new MenuItem();  // an open option
    private final MenuItem saveFile = new MenuItem(); // a save option
    private final MenuItem close = new MenuItem(); // and a close option!
